...
var firstLoad = true;
var latestAds = [];
var wishPriceSearchAds = 12000;
var urlAvitoPageWithAds = 'https://www.avito.ru/rostov-na-donu/kvartiry/sdam/na_dlitelnyy_srok/1-komnatnye?pmax='+ wishPriceSearchAds +'&pmin=1000&district=356&i=1';
...
function getNewAds() {
  ...
  console.log('====================================');
  console.log('Титул: ', latestMatchedItemTitle);
  console.log('Описание: ', _.first(adsByPrice).title);
  console.log('Залог: ', _.size(adsByPrice));
  console.log('Открыть: ', _.first(adsByPrice).link);
  console.log('====================================');
